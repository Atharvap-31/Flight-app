...
import { setFlights } from "../redux/createSlice";
...
const SearchFlights = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      // Step 1: Fetch city info based on `from` and `to`
      ...
      // Step 3: Call the flights API using departure date and IATA codes
      // Format: YYYY-MM-DD
      ...
      const flightResponse = await axios.get(
        ...
        {
          params: {
            access_key: BackendUrl, // Replace with your real access key
            dep_iata: dep_iata,
            arr_iata: arr_iata,
          },
        }
      ...
      const userDate = new Date(values.departureDate)
        .toISOString()
        .split("T")[0];
